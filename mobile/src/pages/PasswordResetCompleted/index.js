    ...
    <View style={styles.containerImage}>
      ...
      >
        <View style={styles.textContainer}>
          <Text style={styles.title}>Reset request sent!</Text>
          <Text style={styles.subTitle}>
            Now you need to check the e-mail that was sent to you to reset your
            password and enjoy your studies.
          </Text>
        </View>
      </ImageBackground>
      <Image
